...
@Component({
  ...
  templateUrl: './foreman-dashboard-router.component.html',
  styleUrls: ['./foreman-dashboard-router.component.css']
})
export class ForemanDashboardRouterComponent implements OnInit {
